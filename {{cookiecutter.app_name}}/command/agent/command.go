...
func (c *Command) Synopsis() string {
	return "Runs a {{cookiecutter.app_name}} agent"
}

func (c *Command) Help() string {
	helpText := `
Usage: {{cookiecutter.app_name}} agent [options]

  Starts the {{cookiecutter.app_name}} agent and runs until an interrupt is received.
